...
AmphetamineXL v2.3 keeps two rollback paths ready at all times:
...
If v2.3’s default profile is too conservative, switch to the hidden compatibility profile without giving up the new cleanup and logging.
